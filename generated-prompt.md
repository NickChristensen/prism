...
- StockQuoteCard: { symbols: Array<string>, variant?: "carousel" | "compact" } - Self-contained stock quote card or quote-card carousel for one or more stock, ETF, index, or crypto quotes. Use directly rather than wrapping in another Card. Pass symbols only; Prism fetches live prices, daily change, intraday data, and comparisons.
