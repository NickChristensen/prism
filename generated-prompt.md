...
- StockQuoteCard: { symbols: Array<string> } - Self-contained stock quote card for one or more stock, ETF, index, or crypto quotes. DO NOT place inside a Card; use a separate Card for commentary if needed. Pass symbols only; Prism fetches and displays live prices, intraday data, and comparisons.
